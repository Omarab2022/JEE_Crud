...
<body>
	...
	<div class="container col-md-8">
		<div class="card  border-primary ">
			<div class="card-header bg-primary border-primary ">Update d'un
				Produit</div>
			<div class="card-body ">
				...
				<div class="form-group">
						...
						<label class="control-label">ID : </label><br> <br><input
							type="text" name="id"  value="${produit.id}" class="form-control" required="required"> <Span></Span>
